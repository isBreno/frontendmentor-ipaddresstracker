...
const AddressInfos = ({
  ...
  Ip?: string | string[];
	...
	return (
		<>
			<section className="absolute right-1/2 mx-auto grid min-h-[200px] w-11/12 max-w-[1200px] translate-x-1/2 -translate-y-24 rounded-2xl bg-white p-8 sm:grid-cols-4">
